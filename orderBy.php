...
<?php
//$sql = "SELECT PartID, PartName, Associated_Image1, Price FROM Allparts";
echo '<a href="index.php"> Go to Home </a>'."<br>";
//$sql="";
if (isset($_POST['Order']) == 'Part ID') {

    $sql = "SELECT PartID, PartName, Associated image filename1, Price FROM Allparts ORDER BY PartID";
}
if (isset($_POST['Order']) == 'Part Name'){

    $sql = "SELECT PartID, PartName, Associated image filename1, Price FROM Allparts ORDER BY PartName";
}
if (isset($_POST['Order']) == 'Price'){

    $sql = "SELECT PartID, PartName, Associated image filename1, Price FROM Allparts ORDER BY Price";
}
